    ...
    return (
        <div className="min-h-screen bg-secondary dark:bg-[#09090B] flex items-center justify-center pt-32 pb-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
            <motion.div
                ...
                className="w-full max-w-[1100px] bg-white dark:bg-[#171717] rounded-none shadow-2xl  border-1 border-[#242424] overflow-visible flex flex-col md:flex-row min-h-[600px] transition-colors duration-300 relative"
            >
                ...
                <div className="hidden md:block w-1/2 relative overflow-hidden group">
                    ...
                    <div className="relative z-20 h-full flex flex-col justify-between p-12 text-white">
                        ...
                        <div>
                            <h2 className="font-fluro text-5xl mb-4 leading-tight font-[Fluro]">Join the <br />Journey</h2>
                            <p className="font-helvetica-light text-xl opacity-90 max-w-xs font-[Helvetica-Neue-UltraLight]">
                                Create an account to start booking your dream destinations today.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full md:w-1/2 p-8 sm:p-12 lg:p-16 flex flex-col justify-center bg-white dark:bg-[#171717] transition-colors duration-300">
                    <div className="max-w-md mx-auto w-full">
                        <div className="mb-10">
                            <h1 className="font-molde-bold text-3xl text-primary dark:text-white mb-2 font-[Neue-Haas-Grotesk-Bold]">Create Account</h1>
                            <p className="text-gray-500 dark:text-gray-400 font-[Neue-Haas-Grotesk-Roman]">
                        ...
                        <p className="mt-8 text-center text-sm text-gray-500 font-[Neue-Haas-Grotesk-Roman]">
                            ...
                            <Link to="/login" className="font-semibold text-brand hover:underline text-[#DA6102] transition-all font-[Neue-Haas-Grotesk-Bold]">
                                Sign in
                            </Link>
                        </p>
                    </div>
